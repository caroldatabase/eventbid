                       ...
                       <div class="panel panel-cascade">
                          <div class="panel-body ">
                              <div class="row">  
                                ...
                                <?php echo Form::model($category, ['method' => 'PATCH', 'route' => ['category.update', $category->id],'class'=>'form-horizontal','id'=>'users_form']); ?>

                                    <?php echo $__env->make('packages::category.form', compact('category'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::close(); ?>
