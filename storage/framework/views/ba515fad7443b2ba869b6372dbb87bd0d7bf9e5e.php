                       ...
                       <div class="panel panel-cascade">
                          <div class="panel-body ">
                              <div class="row">  
                                ...
                                <?php echo Form::model($assignment, ['method' => 'PATCH', 'route' => ['assignment.update', $assignment->id],'class'=>'form-horizontal','id'=>'users_form']); ?>

                                    <?php echo $__env->make('packages::assignment.form', compact('assignment'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::close(); ?>
