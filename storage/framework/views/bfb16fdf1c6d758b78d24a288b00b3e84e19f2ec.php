                            ...
                            <div class="row">
                                <div class="box">
                                    <div class="box-header">
                                        <form action="<?php echo e(route('article')); ?>" method="get">
                                         ...
                                         <div class="col-md-2">
                                             <a href="<?php echo e(route('article')); ?>">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                   ...
                                   <div class="box-body table-responsive no-padding" >
                                             ...
                                             <thead>
                                              <tbody>    
                                                <tr>
                                                    ...
                                                    <td><?php echo ucfirst($result->article_title); ?>


                                                    </td>
                                                    <td><?php echo e($result->category->category_name); ?>



                                                    </td>
                                                    <td>    <?php echo e($result->category->sub_category_name); ?></td>
                                                     <td> 
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('article.edit',$result->id)); ?>">
                                    ...
                                    <div class="center" align="center">  <?php echo $articles->appends(['search' => isset($_GET['search'])?$_GET['search']:''])->render(); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
