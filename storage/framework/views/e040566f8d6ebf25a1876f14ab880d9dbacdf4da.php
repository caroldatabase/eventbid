                  ...
                  <div class="col-md-12">
                       <div class="panel panel-cascade">
                          <div class="panel-body ">
                              <div class="row">  
                                      <?php echo Form::model($syllabus, ['route' => ['syllabus.store'],'class'=>'form-horizontal','id'=>'users_form']); ?>

                                        <?php echo $__env->make('packages::syllabus.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                      <?php echo Form::close(); ?>
