                  ...
                  <div class="col-md-12">
                       <div class="panel panel-cascade">
                          <div class="panel-body ">
                              <div class="row">  
                                      <?php echo Form::model($article, ['route' => ['article.store'],'class'=>'form-horizontal','id'=>'users_form','files' => true]); ?>

                                        <?php echo $__env->make('packages::article.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                      <?php echo Form::close(); ?>
