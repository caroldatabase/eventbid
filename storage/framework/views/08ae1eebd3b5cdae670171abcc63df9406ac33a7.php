                       ...
                       <div class="panel panel-cascade">
                          <div class="panel-body ">
                              <div class="row">  
                                ...
                                <?php echo Form::model($user, ['method' => 'PATCH', 'route' => ['student.update', $user->id],'class'=>'form-horizontal','id'=>'users_form']); ?>

                                    <?php echo $__env->make('packages::users.student.form', compact('user'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::close(); ?>
