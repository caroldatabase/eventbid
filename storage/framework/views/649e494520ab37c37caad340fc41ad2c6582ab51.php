                       ...
                       <div class="panel panel-cascade">
                          <div class="panel-body ">
                              <div class="row">  
                                ...
                                <?php echo Form::model($syllabus, ['method' => 'PATCH', 'route' => ['syllabus.update', $syllabus->id],'class'=>'form-horizontal','id'=>'users_form']); ?>

                                    <?php echo $__env->make('packages::syllabus.form', compact('syllabus'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::close(); ?>
