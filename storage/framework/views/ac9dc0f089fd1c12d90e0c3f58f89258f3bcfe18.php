                                             ...
                                             <thead>
                                              <tbody>    
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="label label-<?php echo e(($user->status==1)?'success':'warning'); ?> status" id="<?php echo e($user->userID); ?>"  data="<?php echo e($user->status); ?>"  onclick="changeStatus(<?php echo e($user->userID); ?>,'user')" >
                                                            <?php echo e(($user->status==1)?'Active':'Inactive'); ?>

                                                        </span>
                                                    </td>
                                                    <td> 
                                                        <a href="<?php echo e(route('user.edit',$user->userID)); ?>">
                                                            <i class="fa fa-fw fa-pencil-square-o" title="edit"></i> 
                                                        </a>

                                                        <?php echo Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$user->userID, 'route' => array('user.destroy', $user->userID))); ?>

                                                        <button class='delbtn btn btn-danger btn-xs' type="submit" name="remove_levels" value="delete" id="<?php echo e($user->userID); ?>"><i class="fa fa-fw fa-trash" title="Delete"></i></button>
