                            ...
                            <div class="row">
                                <div class="box">
                                   ...
                                   <div class="box-body table-responsive no-padding" >
                                        <table class="table table-hover table-condensed">
                                            <thead><tr>
                                                ...
                                                <?php if(count($course)==0): ?>
                                                  ...
                                                  <?php endif; ?>
                                                <?php foreach($course as $key => $result): ?>  
                                             <thead>
                                              <tbody>    
                                                <tr>
                                                    <td><?php echo e(++$key); ?></td>
                                                    <td><?php echo e($result->course_name); ?></td>
                                                    <td><?php echo e($result->session_id); ?></td> 
                                                    <td><?php echo e($result->general_info); ?></td> 
                                                    <td>
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('course.edit',$result->id)); ?>">
                                                            <i class="fa fa-fw fa-pencil-square-o" title="edit"></i> 
                                                        </a>

                                                        <?php echo Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('course.destroy', $result->id))); ?>
                                    ...
                                    <div class="center" align="center">  <?php echo $course->appends(['search' => isset($_GET['search'])?$_GET['search']:''])->render(); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
